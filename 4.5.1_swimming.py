...
#2 swim time changes
#3 gallant checks the temperature before he jumps in
#4 goofus dives in before he checks temperature
#5 breaks out of the loop instead of checking for something again
#6 pretest is before the loop body, posttest is after